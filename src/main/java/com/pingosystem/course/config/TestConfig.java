...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2023-12-12T19:53:07Z"), u1);
		Order o2 = new Order(null, Instant.parse("2023-12-12T03:42:10Z"), u2);
		Order o3 = new Order(null, Instant.parse("2023-12-12T15:21:22Z"), u1);
